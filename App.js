  ...
  return (
    <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
      <Text style={{ paddingBottom: 30 }}>
        Bienvenue, vous allez pouvoir découvrir le fabuleux personnage d'Ada
        Lovelace
      </Text>

      <Button
        onPress={() => navigation.navigate("pileVueduDrawer")}
        title="Voir le profil Ada LOVELACE"
      />
    </View>
  );
}

function AdaLOVELACEScreen({ navigation }) {
  return (
    <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
...
function Biographiecreen({ navigation }) {
  return (
    <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
      <ScrollView>
        <Text>
...
function TheDrawer() {
  return (
    <Drawer.Navigator initialRouteName="Ada LOVELACE">
      ...
      <Drawer.Screen name="Biographie" component={Biographiecreen} />
    </Drawer.Navigator>
  );
}
